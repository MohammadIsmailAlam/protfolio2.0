...
/**
 * Hero — the signature moment of the page: a fake "hero.js" file, typed
...
export function Hero() {
  ...
  return (
    <section id="hero" className="scroll-mt-14 py-20 sm:py-28">
      <Container>
        <Reveal>
          <WindowChrome title="hero.js" bodyClassName="p-0">
            <div className="flex">
              <LineNumbers count={9} />
